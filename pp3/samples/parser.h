...
#include "../include/scanner.h"            // for MaxIdentLen
#include "../include/list.h"        // because we use all these types
#include "../include/ast.h"        // in the union, we need their declarations
